...
function SocialLinks() {
  return (
    <nav className="social" aria-label="Social links">
      <a
        className="social__stamp social__stamp--linkedin"
      ...
      <a
        className="social__stamp social__stamp--email"
      ...
      <a
        className="social__stamp social__stamp--github"
        href="https://github.com/isabellayuu"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="GitHub"
      >
